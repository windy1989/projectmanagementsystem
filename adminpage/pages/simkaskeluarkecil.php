        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Daftar Pengeluaran Kas Kecil</h3>
			   <div class="card-tools">
                  <div class="btn-group">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" role="menu">
                      ...
                      <a href="javascript:void(0);" class="dropdown-item" id="hapuskaskeluarkecil">Hapus</a>
                    </div>
                  </div>
				</div>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="tabelkaskeluarkecil" class="table table-striped table-bordered display responsive wrap" style="width:100%;zoom:0.8;">
                <thead>
	  ...
	  <div class="modal-content">
		...
		<div class="modal-body">
			<div class="row">
				...
				<div class="col-sm-12">
					<button type="button" class="btn btn-primary form-control" id="simpankaskeluarkecil"><i class="far fa-save"></i></button>
				</div>
			</div>
		</div>
  ...
  <div class="modal fade" id="modal-uye">
	  <div class="modal-dialog modal-lg">
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			<div id="image-holder" style="width:100%;"></div>
		  </div>
